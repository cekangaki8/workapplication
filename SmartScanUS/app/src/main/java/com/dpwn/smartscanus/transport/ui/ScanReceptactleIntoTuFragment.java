...
public class ScanReceptactleIntoTuFragment extends AsyncInteractorFragment implements ILoadTransportOutputPort {
    ...
    public void onBarcodeRead(String barcode) {
        if (outputPortHelper.isInProgress()) {
            ...
            if (isTransportUnit(barcode)) {
                ...
                receptacleBarcode = barcode;
                interactor.processReceptacleToTU(activeTransportUnit, barcode, true);
            }
        }
    }
    ...
    public void scanProcessingWarning(MessageResponse msg) {
        ...
        View.OnClickListener processPositiveListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                interactor.processReceptacleToTU(activeTransportUnit, receptacleBarcode,false);

            }
        };

        View.OnClickListener cancelNegativeListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        dlgUtils.showDialogTwoButtons(this.getActivity(), msg.getMsg(),R.drawable.ic_warning_red,"PROCESS",
                processPositiveListener,"CANCEL",null);
